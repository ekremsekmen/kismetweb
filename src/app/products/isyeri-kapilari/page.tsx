...
export const metadata: Metadata = generatePageMetadata({
  title: 'İşyeri Kapıları',
  description:
    'Ofis, mağaza ve işyerleri için profesyonel çelik kapı modelleri. Kartlı geçiş uyumlu, yüksek güvenlik.',
  path: '/products/isyeri-kapilari',
  keywords: [
    'işyeri kapısı',
    'ofis çelik kapı',
    'mağaza kapısı',
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center pt-24 pb-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 text-center sm:px-10 lg:px-20">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Profesyonel Görünüm', 'Yüksek Güvenlik', 'Geçiş Kontrolü', 'Dayanıklı Yapı'].map(
              (tag, index) => (
                <span
                  key={index}
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden bg-gradient-to-br from-white/5 to-white/0">
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="from-steel/20 to-steel/5 relative h-48 w-32 rounded-lg border border-white/20 bg-gradient-to-b shadow-lg transition-transform group-hover:scale-105">
                      ...
                      <div className="bg-primary/20 border-primary/30 absolute top-3 right-3 left-3 flex h-6 items-center justify-center rounded border">
