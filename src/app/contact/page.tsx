...
// Note: Metadata export should be in a separate server component, but for demo purposes keeping it here
// In production, you'd want to move this to a separate layout or handle it differently
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-blue-400">İletişim</span> & Teklif Al
            </h1>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@kismetcelikapi.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Atatürk Mahallesi<br />Çelik Sokak No:15<br />Sultanbeyli/İstanbul</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Pazartesi - Cumartesi<br />08:00 - 18:00</p>
              ...
              <div className="mt-8 space-y-3">
                ...
                <a 
                  ...
                  className="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center"
                >
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-green-800">Mesajınız başarıyla gönderildi!</h3>
      ...
      <section className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">Showroom'umuzda ürünlerimizi yakından inceleyebilirsiniz</p>
          </div>
          ...
          <div className="bg-gray-300 rounded-2xl h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Harita Yakında</h3>
              <p className="text-gray-600">Google Maps entegrasyonu eklenecek</p>
              <p className="text-sm text-gray-500 mt-2">Atatürk Mahallesi, Çelik Sokak No:15, Sultanbeyli/İstanbul</p>
            </div>
          </div>
        </div>
      </section>
